...
const getProducts = (req, res, next) => {
  res.render("./shop/product-list", {
    products:
      product_model_1.productData.dummyProductsArray.length > 0
        ? product_model_1.productData.dummyProductsArray
        : [],
    pageTitle: "Products",
    path: "/shop/products",
    hasProducts: product_model_1.productData.dummyProductsArray.length > 0,
...
const deleteProduct = (req, res, next) => {
  ...
  product_model_1.productData.dummyProductsArray =
    product_model_1.productData.dummyProductsArray.filter(
...
const addToCart = (req, res, next) => {
  ...
  const productId = req.body.productId;
  const product = product_model_1.productData.dummyProductsArray.find(
    (product) => product._id === productId
  );
  if (typeof product === "undefined") {
    const productsFromFile =
      product_model_1.productData.readProductArrFromFile()
        ? product_model_1.productData.readProductArrFromFile()
        : product_model_1.productData.dummyProductsArray;
    console.log("productsFromFile", productsFromFile);
    product_model_1.productData.dummyCartProductsArray.push(
      ...productsFromFile
    );
  } else {
  ...
  console.log(
    ...
    product_model_1.productData.dummyCartProductsArray
  );
  console.log(
    "dummyCartProductsArray",
    product_model_1.productData.dummyCartProductsArray
